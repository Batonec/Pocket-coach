...
# «Пробел каталога» отчёту не нужен — он про состав сессии, а сессию отчёт не
# собирает. Оба списка сверяются с заголовками документа руками (см. CLAUDE.md);
# ненайденный заголовок попадает в промпт предупреждением.
