...
PHASE_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "maintenance": {
        ...
        # Коридор нулевой ширины: матрица сама добавляет допуск (RATE_TOLERANCE).
...
def cycle_position(
    ...
    плановую лёгкую неделю (её объём и веса задаёт стратегия); после неё ramp начинается заново,
