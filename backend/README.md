...
**объём за круг** из четырёх последних тренировок с целями по группам (календарная неделя
остаётся темпом без целей: программа написана под четыре тренировки, атлет ходит через день),
