...
- [backend/recommender.py](./recommender.py) — «Совет тренера»: сборка промпта, оба вызова модели (план и недельный отчёт), один авто-репромпт по нарушениям валидатора
