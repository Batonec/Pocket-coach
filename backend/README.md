...
факты — рабочий вес каждого упражнения в последней сессии перед паузой и оговорку, что
отметки усилия/RIR относятся к той же доперерывной форме, — а системный промпт просит
вести возврат по принятым тренерским принципам работы после простоя. Процентов снижения и
физиологических обоснований в коде нет намеренно: это суждение модели. Единственная жёсткая
граница в валидаторе — вес возвратной сессии не выше доперерывного рабочего (для упражнений
без лестницы разгона; иначе движение, оставленное на пике, проходило по общему коридору
±15% и в первую же сессию после паузы получало прибавку).
