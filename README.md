...
- записывать подход голосом через Siri, не доставая телефон из кармана («Записать подход в Покет Коуч» → «жим ногами 80 на 10, тяжело»; по-английски — «Log a set in Pocket Coach» → «leg press 80 by 10, hard»), с отменой, вопросом «что дальше» и завершением тренировки голосом;
